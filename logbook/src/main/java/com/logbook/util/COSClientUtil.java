...
public class COSClientUtil {
    ...
    public static COSClientUtil getInstance() {
        if (instance == null) {
            synchronized (COSClientUtil.class) {
                if (instance == null) {
                    instance = new COSClientUtil();
                }
            }
        }
        return new COSClientUtil();
    }
     ...
     * @param url
     */
    public void uploadImg2Cos(String url) {
        ...
        try {
            ...
            throw new RequestException(ErrorCodeEnum.FILE_UPLOAD_FAIL);
        }
    }

    public String uploadFile2Cos(MultipartFile file) {
        if (file.getSize() > 10 * 1024 * 1024) {
            throw new RequestException(ErrorCodeEnum.FILE_CANNOT_OVER_SIZE_10M);
        }
